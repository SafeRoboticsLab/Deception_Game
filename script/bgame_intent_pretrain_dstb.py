# ------------------------------------------------------------
# Belief Game with Intent Hypotheses | Pretrains Opponent Policy
...
def visualize(
    env: BeliefGameWithIntentsEnv, policy: SACBestResponse, fig_path: str, vel_list: List[float],
...
if __name__ == "__main__":
  ...
  parser.add_argument(
      ...
      default=os.path.join("config", "intent_pretrain_dstb.yaml")
  )
