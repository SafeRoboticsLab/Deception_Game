# ---------------------------------------------------------------------------------------
# Belief Game | No Belief Robust Baseline | Pretrains Opponent Policy
...
def visualize(
    env: UberNoBeliefEnv, policy: SACBestResponse, fig_path: str, vel_list: List[float],
...
if __name__ == "__main__":
  ...
  parser.add_argument(
      ...
      default=os.path.join("config", "robust_pretrain_dstb.yaml")
  )
