# --------------------------------------------------------------------
# Belief Game | No Belief Robust Baseline | ISAACS
...
from simulators import UberNoBeliefEnv, save_obj, PrintLogger
from agent.isaacs import ISAACS
from script.robust_pretrain_dstb import visualize
...
if __name__ == "__main__":
  ...
  parser.add_argument(
      ...
      default=os.path.join("config", "robust_isaacs.yaml")
  )
